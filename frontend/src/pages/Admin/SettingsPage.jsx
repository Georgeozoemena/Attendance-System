    ...
    return (
        <div className="settings-page animate-fade-in">
            ...
            <section className="settings-section">
                <div className="settings-section-header">
                    <h2>Organization</h2>
                    <p>Details about your church and the system configuration.</p>
                </div>
                ...
                <div className="settings-card">
                    <div className="settings-row border-bottom">
                        <div className="settings-row-info">
                            ...
                            <span className="settings-row-desc">Registered name of the church</span>
                        </div>
                        <span className="settings-row-value">Dominion City</span>
                    </div>
                    <div className="settings-row border-bottom">
                        <div className="settings-row-info">
                            <span className="settings-row-label">Parish</span>
                            <span className="settings-row-desc">Current parish branch</span>
                        </div>
                        <span className="settings-row-value">Olive Parish</span>
                    </div>
                    <div className="settings-row">
                        <div className="settings-row-info">
                            <span className="settings-row-label">System Version</span>
                            <span className="settings-row-desc">Attendance Management System</span>
                        </div>
                        <span className="settings-row-value settings-badge">v1.0 MVP</span>
                    </div>
                </div>
            </section>
                ...
                <div className="settings-card">
                    <div className="settings-row border-bottom">
                        <div className="settings-row-info">
                            ...
                            <span className="settings-row-desc">Admin session expires after inactivity</span>
                        </div>
                ...
                <div className="settings-card">
                    <div className="settings-row border-bottom">
                        <div className="settings-row-info">
                            ...
                            <span className="settings-row-desc">Local SQLite database on the server</span>
                        </div>
                        <span className="settings-row-value">SQLite</span>
                    </div>
                    <div className="settings-row">
                        <div className="settings-row-info">
